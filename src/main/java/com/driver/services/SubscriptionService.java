...
//        userRepository.save(user);
    ...
    public Integer upgradeSubscription(Integer userId)throws Exception{
        ...
        if(subscriptionType.equals(SubscriptionType.ELITE)){
            ...
            bal = 800+250*subscription.getNoOfScreensSubscribed()-subscription.getTotalAmountPaid();
            subscription.setSubscriptionType(SubscriptionType.PRO);
        }
        else {
            bal = 1000+350*subscription.getNoOfScreensSubscribed()-subscription.getTotalAmountPaid();
